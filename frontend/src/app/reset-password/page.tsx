...
import { Droplet, Lock, ArrowLeft, Loader2, CheckCircle2, AlertCircle, Eye, EyeOff } from 'lucide-react';
...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!email || !code) {
      setError('Invalid password reset session. Please start the process again.');
      return;
    }
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://final-year-project-h5uk.onrender.com/api'}/users/reset-password`, {
        method: 'POST',
              ...
              {!isSuccess ? (
                ...
                >
                  <div className="mb-8 text-center sm:text-left">
                    <h1 className="text-2xl font-bold tracking-tight text-slate-900 mb-2">new password</h1>
                    <p className="text-sm text-slate-500 font-medium leading-relaxed">
                      please create a new password that you donnot use on any other site
                    </p>
                  </div>
                ...
                >
                  ...
                  <h2 className="text-2xl font-bold tracking-tight text-slate-900 mb-3">your password changed</h2>
                  <p className="text-slate-500 font-medium leading-relaxed mb-8">
                    your password changed . now you con login with your new password
                  </p>
